...
public class AuthController {
    ...
    public String doLogin(@RequestParam String username,
        ...
        if (user.isPresent() && user.get().getPassword().equals(password)) {
            ...
            // Check role from database first, then fallback to UserID prefix
            String userRole = loggedInUser.getRole();

            if ("Admin".equalsIgnoreCase(userRole) || loggedInUser.getUserId().startsWith("A")) {
                return "redirect:/admin/dashboard";
            } else if ("Driver".equalsIgnoreCase(userRole) || loggedInUser.getUserId().startsWith("D")) {
