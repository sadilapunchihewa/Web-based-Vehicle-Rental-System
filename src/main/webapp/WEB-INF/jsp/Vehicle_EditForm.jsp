...
<div class="d-flex flex-column min-vh-100">
    ...
    <div class="custom-container custom-padding-x py-5">
        <h2 class="fs-2 fw-bold mb-5">Edit Vehicle</h2>
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <form:form modelAttribute="vehicle" action="/vehicle_edit/${vehicle.id}" method="post" enctype="multipart/form-data">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            <label class="form-label text-dark-gray">Status</label>
                            <form:select path="status" class="form-select">
                                <form:option value="Available">Available</form:option>
                                <form:option value="Rented">Rented</form:option>
                                <form:option value="Under Maintenance">Under Maintenance</form:option>
                                <form:option value="Pending Deletion">Pending Deletion</form:option>
                            </form:select>
                        </div>
                        <div class="col-12 d-flex gap-2">
                            <button type="submit" class="btn btn-primary">Save Changes</button>
                            <a href="/vehicle_details/${vehicle.id}" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </div>
                </form:form>
            </div>
    ...
    <!-- Footer -->
    <footer class="bg-dark text-blue text-center py-4">
